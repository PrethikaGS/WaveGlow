...
parser.add_argument('--layer_size', type=int, default=5,
...
parser.add_argument('--sample_rate', type=int, default=1600, help='Sampling rates for input sound')
parser.add_argument('--sample_size', type=int, default=1000, help='Sample size for training input')
